...
function PSEIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <title>PSE - Pagos Seguros en Línea</title>

      <defs>{radialGradientStyles}</defs>
      <ellipse
        id="Circle_1_"
        fill={`url(#${gradientId})`}
        cx="94.345"
      ...
      <g id="PSE_1_">
        <path
          fill="#FFFFFF"
          d="M119.47,71H97.417c-0.099,0-0.198-0.014-0.295,0.006C93.613,71.767,87,75.354,87.034,83.188
        ...
        <path
          fill="#FFFFFF"
          d="M153.047,70.843C152.92,70.807,152.788,71,152.656,71h-16.478c-7.459,0-10.828,8.637-10.967,9.014
        ...
        <path
          fill="#FFFFFF"
          d="M82.84,79.444C83.667,73.817,76.56,71,75.23,71c-0.002,0-0.004,0-0.004,0c-5.739,0-14.433,0.197-15.34,0.166
      ...
      <g id="Figures">
        ...
        <path
          fill="#FDB718"
          d="M15.405,52.808c0-1.839-1.119-3.384-2.665-3.945c-1.306,2.363-2.513,4.789-3.614,7.272
            c0.658,0.531,1.468,0.858,2.356,0.858C13.649,56.993,15.405,55.119,15.405,52.808z"
        />
        <path
          fill="#FDB718"
          d="M7.484,66.019c0-1.135-0.427-2.162-1.115-2.916c-0.806,2.304-1.525,4.648-2.151,7.03
        ...
        <path
          fill="#FDB718"
          d="M6.055,117.005c0-1.745-1.215-3.174-2.79-3.412c0.446,2.067,0.957,4.11,1.538,6.124
        ...
        <path
          fill="#FDB718"
          d="M22.046,104h-7.867c-0.51-1-1.971-2.721-3.715-2.721c-2.167,0-3.923,1.964-3.923,4.275
      ...
      <g id="ach_1_">
        <path
          stroke="#FFFFFF"
          strokeMiterlimit="10"
          d="M54.233,58.499h4.206c0,0,1.233,0.363,1.015,1.813l-0.798,5.584h-4.424c0,0-1.958-0.725-0.943-2.828
        ...
        <polyline
          stroke="#FFFFFF"
          strokeMiterlimit="10"
          points="69.426,55.108 68.815,58.499 67.45,66.077"
        />
        <path
          stroke="#FFFFFF"
          strokeMiterlimit="10"
          d="M68.561,59.91c0,0,0.503-0.995,1.373-1.412c0,0,3.173-0.308,3.735,0.49c0,0,0.635,0.308,0.598,1.215
            l-0.979,5.693"
        />
      </g>
    </svg>
